...
namespace HR_App.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public IActionResult AddNew(string name, string email, IFormFile photo, string phone, string gender, DateTime bhirtdate, string bhirtplace, string position, string department, string address, string nameugd1, string nameugd2, string nameugd3, string emergency1, string emergency2, string emergency3, string status, DateTime contract)
        {
        ...
        public IActionResult Add(string name, string email, IFormFile photo, string phone, string gender, DateTime bhirtdate, string bhirtplace, string position, string department, string address, string nameugd1, string nameugd2, string nameugd3, string emergency1, string emergency2, string emergency3, string status, DateTime contract)
        {
                var path = "wwwroot//images";
                Directory.CreateDirectory(path);
                var FileName= Path.Combine(path, Path.GetFileName(photo.FileName));
