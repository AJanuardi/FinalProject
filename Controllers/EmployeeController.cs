...
namespace HR_App.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        {
        byte[] fileBytes = System.IO.File.ReadAllBytes(@"C:\Users\ASUS\Downloads\FinalProject-1.7.0\wwwroot\"+filePath);
        ...
        {
        var stream = new FileStream(@"C:\Users\ASUS\Downloads\FinalProject-1.7.0\wwwroot\"+filePath, FileMode.Open);
